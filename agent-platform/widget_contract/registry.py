...
SOURCE_STATE_SCHEMA = {"type": "object", "additionalProperties": False,
                        ...
                        "properties": {
                            "status": {"type": "string",
                                       "enum": ["fresh", "stale", "stranded_running",
...
# --- S7c (#472): live Run terminal / activity / review projections ---------
RUN_ARTIFACT_SCHEMA = {"type": "object", "additionalProperties": False,
                       "required": ["ref", "sha256"],
                       "properties": {"ref": {"type": "string"},
                                      "sha256": {"type": ["string", "null"]}}}
RUN_EVIDENCE_SCHEMA = {"type": "object", "additionalProperties": False,
                       "properties": {"kind": {"type": "string"},
                                      "ref": {"type": "string"},
                                      "sha256": {"type": ["string", "null"]}}}
RUN_ERROR_SCHEMA = {"type": ["object", "null"], "additionalProperties": False,
...
RUN_ACTIVITY_ITEM_SCHEMA = {"type": "object", "additionalProperties": False,
                            ...
                            "properties": {
                                ...
                                "event_type": {"type": "string",
                                               "enum": ["run.created", "run.running",
                                                        "run.engine_turn", "run.review_submitted"]},
