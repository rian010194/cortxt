...
Phase 4 needs a child process's own coding work and its heartbeat timer thread to
...
simple, lock-free primitive (Phase 2 design); SessionWriter is the process-local
