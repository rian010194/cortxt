"""
Auto-generated Python stubs for telemetry
...
class TelemetryResponse(TypedDict):
    ...
    errors: Optional[List[TelemetryError]]

# Skill interface
class TelemetrySkill:
    async def call(self, request: TelemetryRequest) -> TelemetryResponse: ...
