...
export default function Agents() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-white mb-2">Agents & Profiles</h1>
        <p className="text-slate-400 max-w-3xl">
          All profiles in AI Workspace with model, provider, cost tier, latency budget and associated skills.
        </p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            type="text"
            placeholder="Search profiles, models, skills..."
            value={filter}
            ...
            <div key={profile.id} className="card hover:border-slate-600 transition-colors">
              ...
              <div className="grid grid-cols-3 gap-3 mb-3">
                <div className="p-2 rounded-lg bg-slate-800/50">
                  ...
                  <div className="text-xs text-slate-500">{profile.provider}</div>
                </div>
                <div className="p-2 rounded-lg bg-slate-800/50">
                  <div className="flex items-center gap-1 text-xs text-slate-500 mb-0.5">
